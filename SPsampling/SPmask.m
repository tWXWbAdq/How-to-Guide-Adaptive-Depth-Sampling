...
for set_ind = 1:length(sets) 
    set = sets{set_ind};
    % input
    RGB_path = fullfile("/home/user/Depth/Datasets/Synthia/",set,"RGB");
    GT_path = fullfile("/home/user/Depth/Datasets/Synthia/",set,"GT");

    % output
    sparse_path = fullfile("/home/user/Depth/Datasets/Synthia/",set,"LiDAR",strcat("sp",num2str(samp_perc)));
